...
import Experiment_traning as training
...
def parse_args():
    ...
    parser.add_argument('--actor-lr', type=float, default=5e-4) # learning_rate delay[1e-3, 1e-4]
    parser.add_argument('--critic-lr', type=float, default=5e-3) # learning_rate delay[1e-2, 1e-3]
    ...
    parser.add_argument('--nb-rollout-steps', type=int, default=150)  # per epoch cycle and MPI worker
